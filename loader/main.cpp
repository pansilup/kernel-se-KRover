...
//printf ("%d, =========\n", __LINE__);   
    ...
    //execState->MoniStartOfSE(0xffffffff810b9de0); //); //addr of x64_sys_setreuid
    ...
    //execState->MoniStartOfSE(0xffffffff810d57f0); //addr of x64_sys_sched_setscheduler
